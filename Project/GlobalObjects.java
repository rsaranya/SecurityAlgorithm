...
public class GlobalObjects {
     ...
     * @param pstrSecondHex : Contains the second hex input value in string
     * format
     ...
     *
     * @param larSplitHexValue : Contains the hex value in string format which
     * is used to retrieve the equivalent value from the S-Box
